...
export const IMAGE_MODELS = [
  ...
  { id: 'gptimage',       name: 'GPT Image 1 Mini — OpenAI',              cost: 0.000008,   tier: '🟢', paidOnly: false },
...
export const LLM_MODELS = [
  ...
  { id: 'openai-fast',   name: 'GPT-5 Nano — Ultra Fast',              paidOnly: false, cost: 0.00082,  tier: '🟢' },  // 0.000025 + 0.0008
  { id: 'gemini-fast',   name: 'Gemini 2.5 Flash Lite — Ultra Fast',   paidOnly: false, cost: 0.00127,  tier: '🟢' },  // 0.000075 + 0.0012
  { id: 'mistral',       name: 'Mistral Small 3.2 — Efficient',        paidOnly: false, cost: 0.00044,  tier: '🟢' },  // 0.0000375 + 0.0004
  { id: 'llama-scout',   name: 'Llama 4 Scout — Long Context MoE',     paidOnly: false, cost: 0.00064,  tier: '🟢' },  // 0.00004 + 0.0006
  { id: 'minimax',       name: 'MiniMax M2.7 — Multi-Language',        paidOnly: false, cost: 0.00255,  tier: '🟢' },  // 0.00015 + 0.0024

  // Medium cost (yellow)
  { id: 'openai',        name: 'GPT-5.4 Nano — Fast & Balanced',       paidOnly: false, cost: 0.0026,  tier: '🟡' },  // 0.0001 + 0.0025
  { id: 'claude-fast',   name: 'Claude Haiku 4.5 — Fast & Intelligent', paidOnly: false, cost: 0.01155,  tier: '🟡' },  // 0.00055 + 0.011
  { id: 'kimi',          name: 'Kimi K2.5 — Agentic + Reasoning',      paidOnly: false, cost: 0.0063,  tier: '🟡' },  // 0.0003 + 0.006
  { id: 'mistral-large', name: 'Mistral Large 3 — Premium Reasoning',  paidOnly: false, cost: 0.00325,  tier: '🟡' },  // 0.00025 + 0.003
  { id: 'mistral-4',     name: 'Mistral Small 4 — Unified Reasoning',  paidOnly: false, cost: 0.00127,  tier: '🟡' },  // 0.000075 + 0.0012
  { id: 'qwen-large',    name: 'Qwen 3.6 Plus — 396B Flagship',        paidOnly: false, cost: 0.00625,  tier: '🟡' },  // 0.00025 + 0.006
  { id: 'deepseek',      name: 'DeepSeek V4 Flash — Reasoning',        paidOnly: false, cost: 0.00063,  tier: '🟡' },  // 0.000063 + 0.000504
  { id: 'nova',          name: 'Nova 2 Lite — 1M Context',             paidOnly: false, cost: 0.00566,  tier: '🟡' },  // 0.000165 + 0.0055
  { id: 'glm',           name: 'GLM-5.1 — 744B MoE Reasoning',        paidOnly: false, cost: 0.0069,   tier: '🟡' },  // 0.0005 + 0.0064
  ...
  // ── Paid Only (requires purchased pollen) ──
  { id: 'gpt-5.4-mini',  name: 'GPT-5.4 Mini — Balanced Speed & Cost', paidOnly: true, cost: 0.00938,  tier: '💎' },  // 0.000375 + 0.009
  { id: 'openai-large',  name: 'GPT-5.4 — Most Powerful',              paidOnly: true, cost: 0.03125,   tier: '💎' },  // 0.00125 + 0.03
  { id: 'gpt-5.5',       name: 'GPT-5.5 — Frontier Reasoning',        paidOnly: true, cost: 0.0625,  tier: '💎' },  // 0.0025 + 0.06
  { id: 'gemini',        name: 'Gemini 3 Flash — Pro-Grade',           paidOnly: true, cost: 0.00938,  tier: '💎' },  // 0.000375 + 0.009
  { id: 'gemini-large',  name: 'Gemini 3.1 Pro — Most Intelligent',    paidOnly: true, cost: 0.0375,  tier: '💎' },  // 0.0015 + 0.036
  { id: 'gemini-3.5-flash', name: 'Gemini 3.5 Flash — Next-Gen',        paidOnly: true, cost: 0.02813,  tier: '💎' },  // 0.001125 + 0.027
  { id: 'gemini-flash-lite-3.1', name: 'Gemini 3.1 Flash Lite — Cost-Effective', paidOnly: true, cost: 0.00469, tier: '💎' }, // 0.0001875 + 0.0045
  { id: 'claude',        name: 'Claude Sonnet 4.6 — Balanced',         paidOnly: true, cost: 0.03465,  tier: '💎' },  // 0.00165 + 0.033
  { id: 'claude-large',  name: 'Claude Opus 4.6 — Most Intelligent',   paidOnly: true, cost: 0.05775,  tier: '💎' },  // 0.00275 + 0.055
  { id: 'claude-opus-4.7', name: 'Claude Opus 4.7 — Latest & Best',   paidOnly: true, cost: 0.05775,  tier: '💎' },  // 0.00275 + 0.055
  { id: 'grok-large',    name: 'Grok 4.20 Reasoning — Agentic',       paidOnly: true, cost: 0.013,   tier: '💎' },  // 0.001 + 0.012
  { id: 'deepseek-pro',  name: 'DeepSeek V4 Pro — Advanced',           paidOnly: true, cost: 0.00783,  tier: '💎' },  // 0.00087 + 0.00696
  { id: 'llama-maverick', name: 'Llama 4 Maverick — Multimodal MoE',  paidOnly: true, cost: 0.00213,  tier: '💎' },  // 0.000125 + 0.002
  { id: 'gemma',         name: 'Gemma 4 26B — Open-source MoE',        paidOnly: true, cost: 0.00071,  tier: '💎' },  // 0.000035 + 0.00068
  { id: 'kimi-k2.6',     name: 'Kimi K2.6 — Latest Agentic',          paidOnly: true, cost: 0.00847,  tier: '💎' },  // 0.000475 + 0.008
];
